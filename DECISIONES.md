...
- **Juguete de la sala del gato:** un gato invisible acecha al cursor. Deja huellas pequeñas de tabaco que se desvanecen en 1,4 s, alternando pata izquierda y derecha cada 30 px a 520 px/s. Cuando alcanza al "ratón", apoya las dos patas juntas, una sola vez. Parado, ignora los movimientos pequeños del ratón y solo vuelve a andar cuando el ratón se aleja más de 45 px, para que las huellas no se amontonen. La pieza destacada sigue girándose hacia el cursor (hasta 10° en Y y 6° en X). En táctil, el gato va al punto que se toca; con teclado, va a la pieza enfocada. Solo usa el ticker compartido mientras camina, recicla 18 huellas y anima solo opacity y transform. Sustituye a la mancha de sol, que el usuario descartó (tampoco le convencieron la luz de ventana ni el rayo).
...
- **Orbes sin filtro** (aprobado): `filter: blur(80px)` se sustituye por un degradado radial con caída gaussiana, y el orbe crece 10rem, el alcance del blur. El aspecto es el mismo, pero ya no hay filtro que recalcular cuando algo se mueve encima. La sala del gato con el juguete activo, a 4× y sin GPU, pasa de 77 ms a 17,8 ms por fotograma.
