...
- **Juguete de la sala del gato:** un gato invisible acecha al cursor. Deja huellas pequeñas de tabaco que se desvanecen en 1,4 s, alternando pata izquierda y derecha cada 30 px a 520 px/s. Cuando alcanza al "ratón", apoya las dos patas juntas. La pieza destacada sigue girándose hacia el cursor (hasta 10° en Y y 6° en X). En táctil, el gato va al punto que se toca; con teclado, va a la pieza enfocada. Solo usa el ticker compartido mientras camina, recicla 18 huellas y anima solo opacity y transform. Sustituye a la mancha de sol, que el usuario descartó (tampoco le convencieron la luz de ventana ni el rayo).
